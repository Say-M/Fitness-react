        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                prepItems: function (opts, d) {
                    ...
                    $(opts).each(function (i, opt) { // parsing options to li
                        ...
                        lis.push(opt.is('optgroup') ?
                            $('<li class="group ' + (opt[0].disabled ? 'disabled' : '') + '' + (opt[0].className ? 'haveClass' : '') + '"><label>' + opt.attr('label') + '</label><ul></ul></li>')
                            .find('ul')
                ...
                setText: function () {
                    ...
                    if (is_placeholder) O.caption.addClass('placeholder multiText');
